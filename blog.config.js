...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '超哥🩷帆帆', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个热爱编程的程序员，一个热爱生活的打工人。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.myxuechao.com/', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京ICP备2023001679号-1', // 备案号 闽ICP备XXXXXXX
